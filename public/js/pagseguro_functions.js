function proccessPayment(token, buttonTarget)
{
    let data = {
        ...
        installment: document.querySelector('select.select_intallments').value,
...
function drawSelectInstallments(installments) {
    ...
    select += '<select class="form-control select_intallments">';
...
function errorsMapPagseguroJs(code) {
    switch (code) {
        case '10000':
            return 'Bandeira do cartão inváida';
            break;
        case '10001':
        ...
        case '10003':
            ...
            break;
        case '10004':
            return 'Código de segurança é obrigatorio';
            break;
        case '10006':
